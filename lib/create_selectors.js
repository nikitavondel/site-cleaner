module.exports = function (parsed_html, callback) {
    ...
    console.log("Creating selector for all elements...");
        ...
        for (var i=0; i < all_elements.length; i++) {
            ...
            do {
                ...
                if (current_element.parent == null) {
                    ...
                    if (typeof current_attribs.id !== "undefined" && current_attribs.id.indexOf(' ') == -1 && current_attribs.id.replace(/\s/g, '').length) {
                        
                        current_selector = " > #" + current_attribs.id + current_selector;
                        
                    } else if (typeof current_attribs.class !== "undefined" && current_attribs.class.indexOf(' ') == -1 && current_attribs.class.replace(/\s/g, '').length) {
    ...
    console.log("Created selectors for all elements.");
